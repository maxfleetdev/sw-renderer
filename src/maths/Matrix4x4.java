...
// Generated by ChatGPT as a boilerplate - to be updated/replaced
...
public class Matrix4x4 {
    ...
    public static Matrix4x4 Perspective(float fov, float aspect, float near, float far) {
        ...
        // Filling the matrix according to the right-handed coordinate system
        result.m[0][0] = f / aspect;                  // X-axis
        result.m[1][1] = f;                           // Y-axis
        result.m[2][2] = (far + near) / (near - far); // Z-axis
        result.m[2][3] = (2 * far * near) / (near - far); // Perspective
        result.m[3][2] = -1;                          // Correct perspective division
        result.m[3][3] = 0;                           // Homogeneous coordinate
